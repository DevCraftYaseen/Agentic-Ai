...
class Review(BaseModel):
        ...
        summary: Annotated[str, 'Write down a brief summary of the review']
        sentiment: Annotated[Literal['Positive', 'Negative', 'Neutral'], 'Return sentiment of the review either Positive, Negative or Neutral']
        pros : Annotated[Optional[list[str]], "Write down all the pros of the review inside a list"] = None
        cons : Annotated[Optional[list[str]], "Write down all the cons of the review inside a list"] = None

structured_model = gemini.with_structured_output(Review)
